...
export default function Header() {
  return (
    <header className="w-full flex justify-center fixed top-0 z-50 pt-5">
      <div className="w-[1136px] flex items-center justify-between border border-white/5 rounded-full bg-[#000015BF] py-4 px-8 shadow-lg">
