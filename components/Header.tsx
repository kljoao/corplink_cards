...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 w-full flex justify-center z-50 pt-5">
      <div className="w-full max-w-[1136px] flex items-center justify-center sm:justify-between border border-white/10 rounded-full bg-[#000015BF] py-4 px-4 sm:px-8 shadow-lg">
        <Link href="/" className="flex items-center gap-2 mx-auto sm:mx-0">
          <Image src={logo} alt="CorpLink Logo" width={180} className="sm:w-[220px] w-[180px] h-auto" />
        </Link>
